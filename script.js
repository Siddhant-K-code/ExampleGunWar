...
var Screen;
(function (Screen) {
    Screen[Screen["Width"] = 100] = "Width";
    Screen[Screen["Height"] = 100] = "Height";
})(Screen || (Screen = {}));
var Character;
(function (Character) {
...
const FPS = 24;
const SCREEN_EDGE = Screen.Width - Character.Width;
...
let app = new Vue({
    ...
    data: {
        ...
        screen: {
            width: Screen.Width + BASIC_UNIT,
            height: Screen.Height + BASIC_UNIT,
        },
        control: {
    ...
    methods: {
        ...
        initializeFirePosition(which) {
            ...
            if (this.fires[which].length < 2) {
                ...
                if (which === Which[Which.Player]) {
                    y = Screen.Height - Character.Height - Fire.Height;
                }
        ...
        moveFire(which) {
            ...
            for (let i in this.fires[which]) {
                ...
                else if (which === Which[Which.Computer] && fire.y > Screen.Height) {
                    this.fires[which].splice(i, 1);
                }
            }
        },
        ...
        fireCollision(which, advance, prediction) {
            ...
            if (which === Which[Which.Computer]) {
                ...
                yCharacter = Screen.Height - Character.Height;
            }
